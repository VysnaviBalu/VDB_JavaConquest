 ...
 */
public class AppForm1Enter {

    private static final Logger logger = LoggerFactory.getLogger(AppForm1Enter.class);

    private final String homeroomTeacherName;
    private final int standard;
    private final String major;

    public AppForm1Enter(Builder builder){
    ...
    public static class Builder {
        ...
        public AppForm1Enter build() {
            return new AppForm1Enter(this);
        }
    }
}
