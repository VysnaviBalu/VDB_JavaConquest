 ...
 *
 */
public class AppFormEnter {
   private static final Logger logger = LoggerFactory.getLogger(AppFormEnter.class);
   // Final - immutable - thread safe , no accidental changes
    ...
    private AppFormEnter(Builder builder){
    ...
    public static class Builder  {
        ...
        public AppFormEnter build(){
            return new AppFormEnter(this);
        }
    }
}
